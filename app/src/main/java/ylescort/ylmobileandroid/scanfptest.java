...
//这个是kim测试成功的例子.
public class scanfptest extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scanfptest);
        InitLayout();
        InitData();
    }
    ...
    private void InitLayout() {
        ...
        btn_match_fp = (Button) findViewById(R.id.btn_match_fp);
        ...
        btn_get_img.setOnClickListener(this);
        btn_get_char.setOnClickListener(this);
        btn_match_fp.setOnClickListener(this);
